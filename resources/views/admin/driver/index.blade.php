    ...
    <x-slot name="scripts">
        ...
        <script>
            function deleteDriver(id) {
                swal({
                    title: "Are you sure?",
                    text: "You won't to delete this Driver...?? Also Delete His Vehicle",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
            ...
            function updateStatusDriver(id) {
                ...
                swal({
                    icon: 'success',
                    text: 'Your Driver status has been updated!',
            ...
            $(document).ready(function () {
                ...
                $('.delete_all').on('click', function (e) {
                    ...
                    if (allVals.length <= 0) {
                        ...
                        swal({
                            title: "Are you sure?",
                            text: "You won't to delete Selected Driver! Also Delete His Vehicle",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        })
