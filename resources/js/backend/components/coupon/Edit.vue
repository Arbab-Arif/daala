                ...
                <div class="intro-y box">
                    ...
                    <div class="p-5" id="form-validation">
                        <div class="preview">
                            <div class="flex flex-wrap -mx-3 mb-2">
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input type="text" name="code" id="code" class="cols-3 input w-full border mt-2"
                                           placeholder="Ex-# code-112" minlength="2" v-model="data.code">
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <button @click="update" v-text="disabled ? 'Updating...' : 'Update'"
...
export default {
    ...
    methods: {
        update: function () {
            ...
            this.disabled = true;
            axios.put(`/admin/coupon/${this.coupon.id}`, this.data)
                .then(() => {
                    this.$alertify.success("CouponList Updated Successfully!");
                    setTimeout(() => {
