                        ...
                        <div class="preview">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <input type="text" name="model" id="model" class="cols-3 input w-full border mt-2"
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-6 mt-4 md:mb-0">
                                    ...
                                    <input type="text" name="year" id="year" class="cols-3 input w-full border mt-2"
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-6 mt-4 md:mb-0">
                                    ...
                                    <input type="text" name="color" id="color" class="cols-3 input w-full border mt-2"
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-1/3 px-3 mb-6 mt-4 md:mb-0">
                                    ...
                                    <input type="file" name="icon" id="icon" class="cols-3 input w-full border mt-2 p-1"
                                           placeholder="10 Per Min" minlength="2" @change="fileSelected($event)">
                                </div>
                            </div>

                            <button @click="update" class="button bg-theme-1 text-white mt-5">Update</button>
...
export default {
    ...
    methods: {
        ...
        update: function () {
            ...
            axios.post(`/admin/vehicle/${this.vehicle.id}`, this.buildFormData())
                .then(() => {
